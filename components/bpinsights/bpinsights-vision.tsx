      ...
      <Container className="relative py-20 lg:py-32">
        ...
        <div className="grid gap-12 lg:grid-cols-[1fr_0.8fr] lg:items-end lg:gap-24">
          <div className="max-w-4xl">
            <p className="text-sm font-semibold tracking-wider text-white/75">
              {vision.eyebrow}
            </p>

            <h2 className="mt-6 text-balance text-5xl font-bold leading-[0.98] tracking-tight text-white lg:text-7xl">
              {vision.title}
            </h2>
          </div>
            ...
            {[
              ...
              return (
                ...
                >
                  ...
                  <ArrowUpRight className="mt-7 size-5 text-white/30 transition-all duration-300 group-hover:-translate-y-1 group-hover:translate-x-1 group-hover:text-white" />
                </div>
              );
            })}
          </div>
        ...
        <div className="mt-16 border-t border-white/10 pt-10 lg:mt-20 lg:pt-12">
          <div className="flex flex-col gap-8 lg:flex-row lg:items-end lg:justify-between">
            <p className="max-w-5xl text-balance text-3xl font-medium leading-tight text-white lg:text-5xl">
              {vision.closing}
            </p>
