        ...
        <div className="flex min-h-[600px] items-center py-20 lg:min-h-[650px] lg:py-24">
          <div className="max-w-5xl">
            ...
            <div className="mt-9">
              <Link
                href="#opportunities"
                className="group inline-flex items-center gap-2 rounded-full bg-primary px-6 py-3.5 text-sm font-semibold text-primary-foreground transition-all duration-300 hover:gap-3 hover:opacity-90"
              >
