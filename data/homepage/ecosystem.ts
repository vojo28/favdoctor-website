export const ecosystem = {
  ...
  description:
    "Every healthcare challenge is different. That's why FavDoctor is building an integrated ecosystem of healthcare platforms that work together to improve health outcomes, strengthen healthcare systems, and create healthier communities.",

  cta: {
    label: "Explore the FavDoctor Ecosystem",
    href: "/ecosystem",
  },
