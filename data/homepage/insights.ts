export const insights = {
  ...
  description:
    "Explore the latest healthcare insights, research, product updates, thought leadership, and stories from across the FavDoctor ecosystem.",

  cta: {
    label: "Read Our Latest Insights",
    href: "/insights",
  },
